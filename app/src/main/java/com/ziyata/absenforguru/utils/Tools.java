...
public class Tools {
    ...
    public static void displayBitmapOriginal(Context ctx, ImageView img, byte[] bitmap) {
        try {
    ...
    public static void setFont(Context ctx,TextView txt){
        Typeface customfont=Typeface.createFromAsset(ctx.getAssets(),"font/Roboto-Light.ttf");
